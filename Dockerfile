...
RUN pip install "boto3>=1.43.32" "botocore>=1.43.32" langchain_aws "langchain[mcp]>=1.4.0" langchain_community langchain-openai langchain-anthropic "openai>=2.41.0" "langgraph>=1.2.11" langgraph-checkpoint-sqlite "langgraph-supervisor>=0.0.31" "langgraph-swarm>=0.1.0" langchain-text-splitters
