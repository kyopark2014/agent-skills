...
이 스크립트는 Agent Skills 애플리케이션에 필요한 AWS 백엔드 리소스를 자동으로 생성합니다. 애플리케이션은 로컬에서 `./run_local.sh` 또는 `uvicorn application.server:app --host 0.0.0.0 --port 8501`로 실행합니다.
...
================================================================
Run locally: ./run_local.sh (uvicorn :8501)
