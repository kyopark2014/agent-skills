...
git_name = "agent-skills"      # Git 저장소 이름
...
================================================================
Summary:
  S3 Bucket: storage-for-agent-skills-{account_id}-us-west-2
  VPC ID: vpc-xxxxxxxxx
  Public Subnets: subnet-xxx, subnet-yyy
  Private Subnets: subnet-aaa, subnet-bbb
  ALB DNS: http://alb-for-agent-skills-xxxxxx.us-west-2.elb.amazonaws.com/
